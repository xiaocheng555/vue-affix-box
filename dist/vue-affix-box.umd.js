(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('throttle-debounce'), require('resize-observer-polyfill')) :
  typeof define === 'function' && define.amd ? define(['throttle-debounce', 'resize-observer-polyfill'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['vue-affix-box'] = factory(global.throttleDebounce, global.ResizeObserver));
}(this, (function (throttleDebounce, ResizeObserver) { 'use strict';
  ...
  var script = {
    ...
    methods: {
      ...
      bindObserver: function bindObserver() {
        ...
        this.observer = new ResizeObserver__default['default'](function (entries) {
